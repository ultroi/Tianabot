...
buttons = [
    [
        InlineKeyboardButton(text="❗Help❗️", callback_data="tiana_"),
    ],
    [
        InlineKeyboardButton(text="👩‍💻Info", callback_data="about_"),
        InlineKeyboardButton(text="Donate💰", url="https://t.me/PrincexDonateBot"),
    ],
   [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Pikachu Updated")
        except Unauthorized:
            LOGGER.warning(
